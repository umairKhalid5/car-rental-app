...
const ConfirmationBox = ({ isSubmitted, onIsSubmitted }) => {
  return (
    ...
    >
      <div className="confirm-box bg-white border-8 border-fontAccent/70 rounded-md shadow-2xl shadow-shadowClr p-2 sm:p-5 py-14 fixed z-30 space-y-6 w-[98%] text-center sm:max-w-lg">
